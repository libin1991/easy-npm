...
class SlideDownContent extends Component<SlideDownContentProps, SlideDownContentState> {
    ...
    private outerRef: HTMLDivElement | any | null = null;
    ...
    private startTransition(prevHeight: string | any) {
        let endHeight: any = '0px';
        ...
        if (parseFloat(endHeight).toFixed(2) !== parseFloat(prevHeight).toFixed(2)) {
            ...
            // @ts-ignore
            let a = this.outerRef.offsetHeight; // force repaint
