...
function PlaceHolder(el, texts, options, cb) {
    this.cb = cb;
    this.el = el;
    this.texts = texts;
    options = options || {};
...
var superplaceholder = function (params) {
    ...
    var instance = new PlaceHolder(params.el, params.sentences, params.options, params.callback);
    return {
        start: function () {
...
export default superplaceholder;
